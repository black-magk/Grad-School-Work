...
brands <- c("mtdew", "reeses", "shocktop", "snickersa","official-channels" )
dataFiles <- paste0("~/Desktop/",brands,".xls")

#############
snickers <- read.xls(dataFiles[4])

jan.11_snickers <- read.xls(dataFiles[4], sheet = 1)
jan.16_snickers <- read.xls(dataFiles[4], sheet = 2)
jan.23_snickers <- read.xls(dataFiles[4], sheet = 3)
jan.30_snickers <- read.xls(dataFiles[4], sheet = 4)
feb.06_snickers <- read.xls(dataFiles[4], sheet = 5)
feb.13_snickers <- read.xls(dataFiles[4], sheet = 6)
...
z<-sum(as.numeric(levels(jan.11_snickers_a$views))[jan.11_snickers_a$views])
z

z<-sum(jan.11_snickers_a$views)
...
head(jan.11_snickers_a$views)

###SNICKERS####

s<-sum(as.numeric(levels(jan.11_snickers_a$views))[jan.11_snickers_a$views])

t<-sum(as.numeric(levels(jan.16_snickers_a$views))[jan.16_snickers_a$views])

u<-sum(as.numeric(levels(jan.23_snickers_a$views))[jan.23_snickers_a$views])

v<-sum(as.numeric(levels(jan.30_snickers_a$views))[jan.30_snickers_a$views])

w<-sum(as.numeric(levels(feb.06_snickers_a$views))[feb.06_snickers_a$views])

x<-sum(as.numeric(levels(feb.13_snickers_a$views))[feb.13_snickers_a$views])


snickers_views_string<-c(s,t,u,v,w,x)

snickers_views_string
