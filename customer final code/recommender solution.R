...
# Load collab.filter function and 2 helper functions before running filters. Currently lines 62-200
...
collab.filter(d,recommend.for="AndrewLong", type="user", distance="manhattan", num.neighbors=9, num.recommendations=5, user.col="id", minkowski.r=NULL, adjusted.ratings=F)
collab.filter(d,recommend.for="AndrewLong", type="user", distance="euclidean", num.neighbors=9, num.recommendations=5, user.col="id", minkowski.r=NULL, adjusted.ratings=F)
collab.filter(d,recommend.for="AndrewLong", type="user", distance="cosine", num.neighbors=9, num.recommendations=5, user.col="id", minkowski.r=NULL, adjusted.ratings=F)

collab.filter(d,recommend.for="AndrewLong", type="item", distance="cosine", num.recommendations=5, user.col="id", minkowski.r=NULL, adjusted.ratings=T)
collab.filter(d,recommend.for="AndrewLong", type="item", distance="correlation", num.recommendations=5, user.col="id", minkowski.r=NULL, adjusted.ratings=T)


# x<-d
# recommend.for<-"AndrewLong"
# type="user"
...
collab.filter<-function(x, recommend.for, type="user", distance="correlation", num.neighbors=1, num.recommendations=1, user.col="id", minkowski.r=NULL, adjusted.ratings=F){
