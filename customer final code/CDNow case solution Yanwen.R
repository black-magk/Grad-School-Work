...
CDNow<-read.csv("/Users/landon/Desktop/customer final code/cdnow_students_transaction.csv")
...
head(num.cds)<-aggregate(CDNow$CDS, by = list(CDNow$ID), FUN = mean)
