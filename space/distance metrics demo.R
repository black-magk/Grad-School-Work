...
# # # # Cosine is sensitive to scaling
# Add a constant to each value

similarity.2<-t(data.frame(c(1 + 5,2 + 5),c(5 + 5,3 + 5)))
...
rownames(similarity.2.cosine)<-c("Alice","Bernard")
colnames(similarity.2.cosine)<-c("Alice","Bernard")
similarity.2.cosine
